...
module.exports = class extends Base {
  async loginByWeixinAction() {
    ...
    //console.log('fullUserInfo is :',fullUserInfo);
    // 解释用户数据
    ...
    //console.log("thisthisthis userid:",userId);
    // 更新登录信息
    var nums = await this.model('user').where({ id: userId }).update({
      last_login_time: parseInt(new Date().getTime() / 1000),
      last_login_ip: clientIp
    });
    //console.log('login this userid:',userId);

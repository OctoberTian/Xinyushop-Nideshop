...
module.exports = class extends Base {
  ...
  async addAction() {
    ...
    //console.log('carInfo',cartInfo);
    //console.log('this.getLoginUserId()',this.getLoginUserId());
  ...
  async checkoutAction() {
    ...
    // 根据收货地址计算运费
    const freightPriceObject = await this.model('freight').where({id: 1}).find();
    var freightPrice = freightPriceObject.freight;
    ...
    if(goodsTotalPrice <= 20){
      freightPrice=0;
    }else{
      console.log('goodsTotalPrice is over 20');
    }

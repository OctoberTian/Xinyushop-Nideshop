...
module.exports = class extends Base {
  ...
  async listAction() {
    ...
    // 搜索到的商品
    var goodsData = await goodsQuery.where(whereMap).field(['id', 'name', 'list_pic_url', 'retail_price','is_on_sale', 'sell_volume']).order(orderMap).page(page, size).countSelect();
